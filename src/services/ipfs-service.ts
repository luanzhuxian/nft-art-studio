...
import { IPFS } from '@src/networkConfig';

const ipfs = ipfsHttpClient({ url: IPFS.RPC_API_ADDRESS });
...
export const testGet = async () => {
  const meta = await axios.get(
    'http://127.0.0.1:8080/ipfs/QmaJ6kjXLxvPNgPaggntvtXuo9D4T2uYcU7sdxuyYV7hKA',
  );
  return meta;
};
